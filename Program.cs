    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            public void CreateMember()
            {
                ...
                {
                    rolodex.Add(new Hacker {Name = memberName, SkillLevel = member, PercentageCut = memberPercentageCut});
                } else if (memberSpecialty == 2)
                {
                    rolodex.Add(new LockSpecialist {Name = memberName, SkillLevel = member, PercentageCut = memberPercentageCut});
                } else
                {
                    rolodex.Add(new Muscle {Name = memberName, SkillLevel = member, PercentageCut = memberPercentageCut});
                }
            }
